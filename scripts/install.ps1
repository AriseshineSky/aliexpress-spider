...
Write-Host "Note: Git is NOT required (dependencies install from GitHub zip)."
...
Write-Host "[3/4] Installing aliexpress-spider and dependencies"
...
Write-Host "  .\scripts\start.bat --headed --no-exit-on-block --captcha-wait 120"
Write-Host ""
